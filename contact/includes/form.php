        ...
        <?php 
            ...
            <?php if(isset($step) && $step=='input'): ?>
                <div class="form-group-index">
                    <p>参加をご希望する教室名を選択ください。</p>
                </div>
            <?php endif; ?>
            
            <div class="contactSect_flex_box">
                <label><span class="contactSect_astarisk">必須</span>都道府県</label>
                <div class="select_07_half selectBoxArrow">
                    <select class="prefectureSelect" name="都道府県" id="" <?= ($step=="confirm")? "readonly=\"readonly\"" :'';  ?>>
            ...
            <?php 
            // ない場合の初期化
            if( !isset($_POST["教室"]) ){ $_POST["教室"] = array(); } 
            ?>
            <div class="contactSect_flex_box">
                <label><span class="contactSect_any">任意</span>教室</label>
                <?php include(__DIR__ . '/classroom.php');  ?>
                <?php if(isset($step) && $step=='confirm'): ?>
                    <p class="confirmPostText">
                        <?php 
                            if(isset($_POST["教室"]) && is_array($_POST["教室"])) {
                                foreach($_POST["教室"] as $selectedClassroom) {
                ...
                <?php endif; ?>
                <?php if (isset($_SESSION['ERROR']['教室'])) : ?>
                    <div class="p-form__container">
                        <div class="c-error">
                            <?= (isset($_SESSION["ERROR"]["教室"])) ? h($_SESSION["ERROR"]["教室"]) : ""; ?>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <?php 
            // ない場合の初期化
            if( !isset($_POST["希望コース"]) ){ $_POST["希望コース"] = array(); } 
            ?>
            <div class="contactSect_flex_box">
                <label><span class="contactSect_astarisk">必須</span>希望コース</label>
                <div class="contactSect_select_item course">
                    <label class="inline" for="PC-ICTコース　幼児コース">
                        <input type="radio" id="PC-ICTコース　幼児コース" name="希望コース[]" value="PC-ICTコース　幼児コース" <?php if(in_array("PC-ICTコース　幼児コース",$_POST["希望コース"])) echo "checked" ; ?>  <?= ($step=="confirm")? "disabled=\"disabled\"" :'';  ?>/>PC-ICTコース　幼児コース
                        <span class="lbl_checkbox"></span>
                    </label>
                    <label class="inline" for="PC-ICT + ロジカ　初級コース　小学生">
                        <input type="radio" id="PC-ICT + ロジカ　初級コース　小学生" name="希望コース[]" value="PC-ICT + ロジカ　初級コース　小学生" <?php if(in_array("PC-ICT + ロジカ　初級コース　小学生",$_POST["希望コース"])) echo "checked" ; ?>  <?= ($step=="confirm")? "disabled=\"disabled\"" :'';  ?>/>PC-ICT + ロジカ　初級コース　小学生
                        <span class="lbl_checkbox"></span>
                    </label>
                    <label class="inline" for="PC-ICT + ロジカ　中・上級コース　中高生">
                        <input type="radio" id="PC-ICT + ロジカ　中・上級コース　中高生" name="希望コース[]" value="PC-ICT + ロジカ　中・上級コース　中高生" <?php if(in_array("PC-ICT + ロジカ　中・上級コース　中高生",$_POST["希望コース"])) echo "checked" ; ?>  <?= ($step=="confirm")? "disabled=\"disabled\"" :'';  ?>/>PC-ICT + ロジカ　中・上級コース　中高生
                        <span class="lbl_checkbox"></span>
                    </label>
                    <label class="inline" for="選択しない">
                        <input type="radio" id="選択しない" name="希望コース[]" value="選択しない" <?php if(in_array("選択しない",$_POST["希望コース"])) echo "checked" ; ?>  <?= ($step=="confirm")? "disabled=\"disabled\"" :'';  ?>/>選択しない
                        <span class="lbl_checkbox"></span>
                    </label>
                </div>
                <?php if(isset($step) && $step=='confirm'): ?>
                    <p class="confirmPostText">
                        <?php 
                            if(isset($_POST["希望コース"]) && is_array($_POST["希望コース"])) {
                                foreach($_POST["希望コース"] as $selectedClassroom) {
                                    echo htmlspecialchars($selectedClassroom) . "<br>";
                                }
                            }
                        ?>    
                ...
                <?php endif; ?>
                <?php if (isset($_SESSION['ERROR']['希望コース'])) : ?>
                    <div class="p-form__container">
                        <div class="c-error">
                            <?= (isset($_SESSION["ERROR"]["希望コース"])) ? h($_SESSION["ERROR"]["希望コース"]) : ""; ?>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <?php 
            // ない場合の初期化
            if( !isset($_POST["バレッドＸ"]) ){ $_POST["バレッドＸ"] = array(); } 
            ?>
            <div class="contactSect_flex_box">
                <label><span class="contactSect_astarisk">必須</span>バレッドＸ</label>
                <div class="contactSect_select_item bullet">
                    <label class="inline" for="希望する">
                        <input type="radio" id="希望する" name="バレッドＸ[]" value="希望する" <?php if(in_array("希望する",$_POST["バレッドＸ"])) echo "checked" ; ?>  <?= ($step=="confirm")? "disabled=\"disabled\"" :'';  ?>/>希望する
                        <span class="lbl_checkbox"></span>
                    </label>
                    <label class="inline" for="希望しない">
                        <input type="radio" id="希望しない" name="バレッドＸ[]" value="希望しない" <?php if(in_array("希望しない",$_POST["バレッドＸ"])) echo "checked" ; ?>  <?= ($step=="confirm")? "disabled=\"disabled\"" :'';  ?>/>希望しない
                        <span class="lbl_checkbox"></span>
                    </label>
                </div>
                <?php if(isset($step) && $step=='confirm'): ?>
                    <p class="confirmPostText">
                        <?php 
                            if(isset($_POST["バレッドＸ"]) && is_array($_POST["バレッドＸ"])) {
                                foreach($_POST["バレッドＸ"] as $selectedClassroom) {
                                    echo htmlspecialchars($selectedClassroom) . "<br>";
                                }
                            }
                        ?>    
                ...
                <?php endif; ?>
                <?php if (isset($_SESSION['ERROR']['バレッドＸ'])) : ?>
                    <div class="p-form__container">
                        <div class="c-error">
                            <?= (isset($_SESSION["ERROR"]["バレッドＸ"])) ? h($_SESSION["ERROR"]["バレッドＸ"]) : ""; ?>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="contactSect_flex_box">
                <label><span class="contactSect_astarisk">必須</span>参加希望日</label>
                <div class="select_07_half inputDate">
                    <input id="参加希望日" type="date" name="参加希望日" value="<?=h($_POST["参加希望日"]??""); ?>" <?= ($step=="confirm")? "hidden" :'';  ?>>
                    <label for="参加希望日">
                        <img src="/images/common/contact_icon_date.svg" alt="">
                    </label>
                </div>
                <?php if(isset($step) && $step=='confirm'): ?>
                    <p class="confirmPostText"><?php echo $_POST['参加希望日']; ?></p>
                <?php endif; ?>
                <?php if (isset($_SESSION['ERROR']['参加希望日'])) : ?>
                    <div class="p-form__container">
                        <div class="c-error">
                            <?= (isset($_SESSION["ERROR"]["参加希望日"])) ? h($_SESSION["ERROR"]["参加希望日"]) : ""; ?>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <?php if(isset($step) && $step=='input'): ?>
                <div class="mar-t30 form-group-index">
                    <p>お子様とご家族についてご記載ください。</p>
                </div>
            <?php endif; ?>

            <div class="contactSect_flex_box">
                <label><span class="contactSect_astarisk">必須</span>お子さまのお名前</label>
                <input type="text" name="お子さまのお名前" value="<?=h($_POST["お子さまのお名前"]??""); ?>" <?= ($step=="confirm")? "hidden" :'';  ?> >
                <?php if(isset($step) && $step=='confirm'): ?>
                    <p class="confirmPostText"><?php echo $_POST['お子さまのお名前']; ?></p>
                <?php endif; ?>
                <?php if(isset($step) && $step=='input'): ?>
                    <div class="explain-txt"><span>※姓と名の間に全角スペースを入れてください。</span></div>
                <?php endif; ?>
                <?php if (isset($_SESSION['ERROR']['お子さまのお名前'])) : ?>
                    <div class="p-form__container">
                        <div class="c-error">
                            <?= (isset($_SESSION["ERROR"]["お子さまのお名前"])) ? h($_SESSION["ERROR"]["お子さまのお名前"]) : ""; ?>
                        </div>
                    </div>
                <?php endif; ?> 
            </div>
            ...
            <div class="contactSect_flex_box">
                <label><span class="contactSect_astarisk">必須</span>お子さまのお名前のフリガナ</label>
                <input type="text" name="お子さまのお名前のフリガナ" value="<?=h($_POST["お子さまのお名前のフリガナ"]??""); ?>" <?= ($step=="confirm")? "hidden" :'';  ?> >
                <?php if(isset($step) && $step=='confirm'): ?>
                    <p class="confirmPostText"><?php echo $_POST['お子さまのお名前のフリガナ']; ?></p>
                <?php endif; ?>
                <?php if(isset($step) && $step=='input'): ?>
                    <div class="explain-txt"><span>※姓と名の間に全角スペースを入れてください。</span></div>
                <?php endif; ?>
                <?php if (isset($_SESSION['ERROR']['お子さまのお名前のフリガナ'])) : ?>
                    <div class="p-form__container">
                        <div class="c-error">
                            <?= (isset($_SESSION["ERROR"]["お子さまのお名前のフリガナ"])) ? h($_SESSION["ERROR"]["お子さまのお名前のフリガナ"]) : ""; ?>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="contactSect_flex_box">
                <label><span class="contactSect_astarisk">必須</span>保護者のお名前</label>
                <input type="text" name="保護者のお名前" value="<?=h($_POST["保護者のお名前"]??""); ?>" <?= ($step=="confirm")? "hidden" :'';  ?> >
                <?php if(isset($step) && $step=='confirm'): ?>
                    <p class="confirmPostText"><?php echo $_POST['保護者のお名前']; ?></p>
                <?php endif; ?>
                <?php if(isset($step) && $step=='input'): ?>
                    <div class="explain-txt"><span>※姓と名の間に全角スペースを入れてください。</span></div>
                <?php endif; ?>
                <?php if (isset($_SESSION['ERROR']['保護者のお名前'])) : ?>
                    <div class="p-form__container">
                        <div class="c-error">
                            <?= (isset($_SESSION["ERROR"]["保護者のお名前"])) ? h($_SESSION["ERROR"]["保護者のお名前"]) : ""; ?>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="contactSect_flex_box">
                <label><span class="contactSect_astarisk">必須</span>お子さまの学年</label>
                <!-- <input class="" type="text" name="お子さまの学年" value="<?=h($_POST["お子さまの学年"]??""); ?>" <?= ($step=="confirm")? "readonly=\"readonly\"" :'';  ?>> -->
                <div class="select_07_half selectBoxArrow">
                    <select name="お子さまの学年" id="" <?= ($step=="confirm")? "readonly=\"readonly\"" :'';  ?>>
                        <option value="年中" <?php if(!empty($_POST["お子さまの学年"]) && $_POST["お子さまの学年"] === "年中") echo "selected" ; ?>>年中</option>
                        <option value="年長" <?php if(!empty($_POST["お子さまの学年"]) && $_POST["お子さまの学年"] === "年長") echo "selected" ; ?>>年長</option>
                        <option value="小学１年生" <?php if(!empty($_POST["お子さまの学年"]) && $_POST["お子さまの学年"] === "小学１年生") echo "selected" ; ?>>小学１年生</option>
                        <option value="小学２年生" <?php if(!empty($_POST["お子さまの学年"]) && $_POST["お子さまの学年"] === "小学２年生") echo "selected" ; ?>>小学２年生</option>
                        <option value="小学３年生" <?php if(!empty($_POST["お子さまの学年"]) && $_POST["お子さまの学年"] === "小学３年生") echo "selected" ; ?>>小学３年生</option>
                        <option value="小学４年生" <?php if(!empty($_POST["お子さまの学年"]) && $_POST["お子さまの学年"] === "小学４年生") echo "selected" ; ?>>小学４年生</option>
                        <option value="小学５年生" <?php if(!empty($_POST["お子さまの学年"]) && $_POST["お子さまの学年"] === "小学５年生") echo "selected" ; ?>>小学５年生</option>
                        <option value="小学６年生" <?php if(!empty($_POST["お子さまの学年"]) && $_POST["お子さまの学年"] === "小学６年生") echo "selected" ; ?>>小学６年生</option>
                        <option value="中学１年生" <?php if(!empty($_POST["お子さまの学年"]) && $_POST["お子さまの学年"] === "中学１年生") echo "selected" ; ?>>中学１年生</option>
                        <option value="中学２年生" <?php if(!empty($_POST["お子さまの学年"]) && $_POST["お子さまの学年"] === "中学２年生") echo "selected" ; ?>>中学２年生</option>
                        <option value="中学３年生" <?php if(!empty($_POST["お子さまの学年"]) && $_POST["お子さまの学年"] === "中学３年生") echo "selected" ; ?>>中学３年生</option>
                        <option value="高校１年生" <?php if(!empty($_POST["お子さまの学年"]) && $_POST["お子さまの学年"] === "高校１年生") echo "selected" ; ?>>高校１年生</option>
                        <option value="高校２年生" <?php if(!empty($_POST["お子さまの学年"]) && $_POST["お子さまの学年"] === "高校２年生") echo "selected" ; ?>>高校２年生</option>
                        <option value="高校３年生" <?php if(!empty($_POST["お子さまの学年"]) && $_POST["お子さまの学年"] === "高校３年生") echo "selected" ; ?>>高校３年生</option>
                    </select>
                    <?php if(isset($step) && $step=='confirm'): ?>
                        <p class="confirmPostText"><?php echo $_POST['お子さまの学年']; ?></p>
                    <?php endif; ?>
                </div>
                <?php if (isset($_SESSION['ERROR']['お子さまの学年'])) : ?>
                    <div class="p-form__container">
                        <div class="c-error">
                            <?= (isset($_SESSION["ERROR"]["お子さまの学年"])) ? h($_SESSION["ERROR"]["お子さまの学年"]) : ""; ?>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="contactSect_flex_box">
                <label><span class="contactSect_astarisk">必須</span>郵便番号</label>
                <input class="" type="text" name="郵便番号" value="<?=h($_POST["郵便番号"]??""); ?>" <?= ($step=="confirm")? "hidden" :'';  ?>>
                <?php if(isset($step) && $step=='confirm'): ?>
                    <p class="confirmPostText"><?php echo $_POST['郵便番号']; ?></p>
                <?php endif; ?>
                <?php if(isset($step) && $step=='input'): ?>
                    <div class="explain-txt"><span>ハイフンを入れて記載ください。例: 100-0011</span></div>
                <?php endif; ?>
            ...
            <div class="contactSect_flex_box">
                <label><span class="contactSect_astarisk">必須</span>連絡先（携帯でもOK）</label>
                <input class="" type="text" name="連絡先（携帯でもOK）" value="<?=h($_POST["連絡先（携帯でもOK）"]??""); ?>" <?= ($step=="confirm")? "hidden" :'';  ?>>
                <?php if(isset($step) && $step=='confirm'): ?>
                    <p class="confirmPostText"><?php echo $_POST['連絡先（携帯でもOK）']; ?></p>
                <?php endif; ?>
                <?php if (isset($_SESSION['ERROR']['連絡先（携帯でもOK）'])) : ?>
                    <div class="p-form__container">
                        <div class="c-error">
                            <?= (isset($_SESSION["ERROR"]["連絡先（携帯でもOK）"])) ? h($_SESSION["ERROR"]["連絡先（携帯でもOK）"]) : ""; ?>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <!-- <div class="mar-t30 form-group-index">
                <p>ご兄弟やお友達など、御一緒に参加されるお子様が他にいる場合は人数とお名前をお知らせください。</p>
            </div>
            
            <div class="contactSect_flex_box">
                <label><span class="contactSect_astarisk">必須</span>その他のお子様の人数</label>
                <div class="contactSect_select_item">
                    <span>子ども
                    <input class="sec_07_short" type="number" name="人数" value="<?=h($_POST["人数"]??"0"); ?>" style="text-align:center;" <?= ($step=="confirm")? "readonly=\"readonly\"" :'';  ?>>
                    人</span> 
                </div>
                <?php if (isset($_SESSION['ERROR']['人数'])) : ?>
                    <div class="p-form__container">
                        <div class="c-error">
                            <?= (isset($_SESSION["ERROR"]["人数"])) ? h($_SESSION["ERROR"]["人数"]) : ""; ?>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="contactSect_flex_box">
                <label>参加するお子様のお名前</label>
                <input type="text" name="参加するお子様のお名前" value="<?=h($_POST["参加するお子様のお名前"]??""); ?>" <?= ($step=="confirm")? "readonly=\"readonly\"" :'';  ?> >
                <div class="explain-txt"><span>御一緒に参加されるお子様のお名前をご記載ください</span></div>
                <?php if (isset($_SESSION['ERROR']['参加するお子様のお名前'])) : ?>
                    <div class="p-form__container">
                        <div class="c-error">
                            <?= (isset($_SESSION["ERROR"]["参加するお子様のお名前"])) ? h($_SESSION["ERROR"]["参加するお子様のお名前"]) : ""; ?>
                        </div>
                    </div>
                <?php endif; ?>
            </div> -->
